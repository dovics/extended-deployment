...
var (
	skipSuit               = os.Getenv("SUIT_SKIP") == "true"
	skipBuild              = os.Getenv("BUILD_SKIP") == "true"
	...
	projectImage = "dovics1/extended-deployment:main"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting extended-deployment integration test suite\n")
