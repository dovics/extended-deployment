...
//+kubebuilder:rbac:groups=inplaceset.cib.io,resources=deployregions,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=inplaceset.cib.io,resources=deployregions/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=inplaceset.cib.io,resources=deployregions/finalizers,verbs=update
